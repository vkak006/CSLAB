...
for j in range(len(testData_in_list)):
    ...
    realFp = open("chartData/FFNN/sch/PH"+str(PH)+"/"+schTestFileName[j]+"-real.txt", "w")
    predictFp = open("chartData/FFNN/sch/PH"+str(PH)+"/"+schTestFileName[j]+"-predict.txt", "w")

    #고/저혈당 실제-예측 횟수 데이터 텍스트 파일로 저장
    predictedHyperFp = open("chartData/FFNN/sch/PH"+str(PH)+"/"+schTestFileName[j]+"-predictedHyperList.txt", "w")
    desiredHyperFp = open("chartData/FFNN/sch/PH"+str(PH)+"/"+schTestFileName[j]+"-desiredHyperList.txt", "w")
    
    predictedHypoFp = open("chartData/FFNN/sch/PH"+str(PH)+"/"+schTestFileName[j]+"-predictedHypoList.txt", "w")
    desiredHypoFp = open("chartData/FFNN/sch/PH"+str(PH)+"/"+schTestFileName[j]+"-desiredHypoList.txt", "w")

    falseHighFp = open("chartData/FFNN/sch/PH"+str(PH)+"/"+schTestFileName[j]+"-falseHigh.txt", "w")
    falseLowFp =open("chartData/FFNN/sch/PH"+str(PH)+"/"+schTestFileName[j]+"-falseLow.txt", "w")
