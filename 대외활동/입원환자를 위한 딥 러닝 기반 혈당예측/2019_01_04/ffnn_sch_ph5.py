...
x = tf.placeholder(tf.float32, [None, 3], name='x') # Input placeholder
...
Wh1 = tf.Variable(tf.random_uniform([3, 15], minval = -1, maxval = 1, dtype = tf.float32))
